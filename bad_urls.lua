--[[    lua script : bad_urls.lua
	purpose    : to check the url is matched in blacklisted PhishTank.com or not
	rule       : reject tcp any any -> any any (msg:"PhishTank.com blacklisted URL"; luajit:bad_urls.lua; priority:1; sid: 100000000000; rev:1;)
